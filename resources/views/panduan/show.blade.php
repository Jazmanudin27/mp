...
<div class="row">
    ...
    <div class="col-lg-8 col-md-12 col-sm-12 mb-4">
        ...
        <a href="{{ route('panduan.index') }}"
            class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center gap-1 mb-3">
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        @foreach ($related as $rel)
                            <a href="{{ route('panduan.show', $rel->slug) }}"
                                class="list-group-item list-group-item-action d-flex align-items-center gap-2 py-3 border-0 border-bottom">
            ...
            <div class="card-body p-0">
                <div class="list-group list-group-flush">
                    @foreach ($allCategories as $cat)
                        <a href="{{ route('panduan.index', ['search' => $cat]) }}"
                            class="list-group-item list-group-item-action d-flex justify-content-between align-items-center py-2_5 border-0 border-bottom">
        ...
        <div class="card shadow-sm border text-center p-4" style="background-color: #f8fafc;">
            ...
            <p class="text-muted small mb-3">Tanyakan langsung ke asisten bot kami di panel chat melayang untuk
                penjelasan detail fitur lainnya.</p>
